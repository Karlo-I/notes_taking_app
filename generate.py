...
- Use optional stage directions in square brackets for pacing: [pause], [emphasis], [slowly].
- Avoid dense jargon. When a technical term is necessary, define it conversationally on first use.
- Structure: brief intro that frames why this topic matters → body that develops the core ideas → conclusion that lands on a memorable takeaway.
...
- The tone should match someone thinking out loud with confidence but not arrogance.""",
...
- If the retrieved notes leave significant gaps on the topic, add a brief final paragraph titled "Limitations" noting what the KB doesn't cover.
